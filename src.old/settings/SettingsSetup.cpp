...
$on_mod(Loaded) {
    ...
    Mod::get()->addCustomSetting<ClickTypeValue>("clicksound-type", matjson::parse(R"({"tab":1,"click":0,"memeClick":0,"customClick":"..."})"));
    Mod::get()->addCustomSetting<ReleaseTypeValue>("releasesound-type", matjson::parse(R"({"tab":1,"click":0,"memeClick":0,"customClick":"..."})"));
