# Changelog
## Version v2.3.0
* Added an experimental 'sounds everywhere' option that continues playing click sounds outside of gameplay. Botters should avoid using this as it is incompatible with every macro bot.
